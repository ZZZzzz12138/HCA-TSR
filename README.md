...
> **Paper-related code.**  
> This repository provides the official implementation related to our manuscript currently submitted to *The Visual Computer*. The code, modules, and experimental utilities in this repository are directly associated with the proposed HCA-TSR method described in the submitted paper.
>
> If you find this repository useful for your research, please consider citing the related paper once it becomes available.
>
> **Code archive DOI:** [10.5281/zenodo.19651421](https://doi.org/10.5281/zenodo.19651421)
